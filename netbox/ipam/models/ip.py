...
class GetAvailablePrefixesMixin:
    ...
    def get_first_available_prefix(self):
        ...
        return available_prefixes.iter_cidrs()[0] if available_prefixes else None
...
class Prefix(GetAvailablePrefixesMixin, PrimaryModel):
    ...
    def get_first_available_ip(self):
        ...
        return (
            f'{next(available_ips.__iter__())}/{self.prefix.prefixlen}'
            if available_ips
            else None
        )
...
class IPRange(PrimaryModel):
    ...
    def first_available_ip(self):
        ...
        available_ips = self.get_available_ips()
        return (
            f'{next(available_ips.__iter__())}/{self.start_address.prefixlen}'
            if available_ips
            else None
        )
